...
public class ViewPagerAdapter extends FragmentPagerAdapter {
    ...
    public ViewPagerAdapter(FragmentManager fm, Context context, ArrayList<Summary> summary, HashMap<String, ArrayList<GameMap>> listOfMaps, List<ArrayList<Achievement>> listOfAchievements, HashMap<String, ArrayList<Weapon>> listOfWeapons) {
        super(fm);
